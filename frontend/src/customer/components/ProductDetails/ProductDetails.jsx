    ...
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10">
          ...
          {/* Product info */}
          <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-16 lg:max-w-7xl lg:px-8 lg:pb-24">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-50 text-sm">5500 Ratings</p>
            ...
            <Grid container spacing={7}>
              ...
              <Grid item xs={5} justifyContent="flex-start">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-60 text-left">564856 Ratings</p>
                </div>
                      ...
                      <LinearProgress
                        sx={{
                          ...
                          "& .MuiLinearProgress-bar": {
                            // Progress bar color
                            bgcolor: "#FFD700", // Set this to your desired yellow color
                          },
                        }}
                        variant="determinate"
                        value={25}
